...
import com.formos.student.dao.StudentDao;
...
public class AppModule
{
    public static void bind(ServiceBinder binder)
    {
    	...
    	binder.bind(IStudentService.class, StudentServiceImpl.class);
    	binder.bind(IStudentDao.class, StudentDao.class);
    }
            ...
            MappedConfiguration<String, Object> configuration)
    {
		...
		configuration.add("tapestry.login-page-name", "Login");
        ...
        configuration.add(SymbolConstants.HMAC_PASSPHRASE, "a14vtqcedbqicq9k7v42tjkdp3");
    }
